        ...
        function updatePayrollInfo() {
            ...
            fetch('/dashboard/payroll/get-attendance-count/' + tag + '/' + monthYearValue)
                ...
                .then(data => {
                    ...
                    var bonus = holidayCount <= 2 ? 100000 : 0; // ganti dinamis
                    ...
                    fetch('/dashboard/payroll/get-holiday-salary/' + postId)
                        ...
                        .then(data => {
                            ...
                            // kondisi jika absen 0

                            document.getElementById('holiday_salary_display').textContent = formatCurrency(
                                Salaryholiday);
                            ...
                            document.getElementById('total_salary_display').textContent = formatCurrency(
                                totalSalary);
                    ...
                    fetch('/dashboard/payroll/get-transport')
                        ...
                        .then(data => {
                            ...
                            document.getElementById('total_transport_display').textContent = formatCurrency(
                                totalTransport);
            ...
            Promise.all([
                    ...
                    fetch('/dashboard/payroll/get-attendance-count/' + tag + '/' + monthYearValue).then(res => res
                        .json()),
                ...
                ]).then(([salaryData, lateCountData, attendanceCountData, SalaryholidayData, transportData,
                    fineValueData
                ]) => {
